...
def main():
    ...
    tokenizer_directory = Path("model2/tokenizers")
    ...
    train_loader = DataLoader(training_dataset, batch_size=16, shuffle=True, collate_fn=collate_fn)
    validation_loader = DataLoader(validation_dataset,batch_size=16,shuffle=True,collate_fn=collate_fn)
